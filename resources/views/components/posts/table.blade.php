<div class="hidden">{{ $number = 0 }}</div>
{{-- jika berhasil upload akan menampilkan popup ini --}}
@if (Session::has('success'))
    <div class="flex justify-center">
        <div id="toast-success"
            class="absolute top-32 flex items-center w-full max-w-md p-4 mb-4 text-gray-500 bg-white rounded-2xl shadow-xl dark:text-gray-400 dark:bg-gray-800"
            role="alert">
            <div
...
@endif
{{-- popup jika berhasil menghapus --}}
@if (Session::has('deleted'))
<div class="flex justify-center">
    <div id="toast-danger"
        class="absolute top-32 flex items-center w-full max-w-lg p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800"
        role="alert">
        <div
        ...
        <div class="ms-3 text-sm font-normal">{{ Session::get('deleted') }}</div>
        <button type="button"
            class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
...
<section class="p-3 sm:p-5 antialiased">
    <div class="max-w-screen-xl px-4">
        <h2 class="mb-4 font-semibold text-2xl">Post by {{ Auth::user()->name }}</h2>
