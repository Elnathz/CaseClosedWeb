...
<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" name="avatar" id="avatar_help">.png .jpg or
                .jpeg
                @error('avatar')
        ...
        <div>
            <img class="w-20 h-20 rounded-full"
                src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('img/default-profile.jpg') }}"
